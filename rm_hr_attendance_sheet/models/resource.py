...
class ResourceCalendar(models.Model):
    ...
    def _cds_attendance_intervals_batch(self, start_dt, end_dt, resources=None, domain=None, tz=None):
        """ Return the attendance intervals in the given datetime range.
            ...
            Supports hour_to >= 24 for overnight/next-day shifts.
        """
        self.ensure_one()
            ...
            for resource in resources_list:
                ...
                for day in days:
                    ...
                    if (tz, day, hour_to) in cache_deltas:
                        ...
                        if hour_to >= 24:
                            # overnight shift: hour_to wraps into the next day
                            hour_to_adj = hour_to - 24
                            next_day = day + timedelta(days=1)
                            day_time = next_day + relativedelta(hours=hour_to_adj)
